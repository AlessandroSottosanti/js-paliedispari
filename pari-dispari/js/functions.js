// ESECUZIONE LOGICA
/**
 * Genera un numero random compreso tra il numero minimo ed il numero massimo passati
 * come argomento
 * @param {number} min
 * @param {number} max
 * @returns {number}
...
/**
 * Determina se un numero è pari o dispari e restituisce il risultato come stringa
 * @param {number} num
 * @returns {string}
 */
